...
package summary.class_2024_02_06.ex01;
...
public class Exam0110 {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("mariaDriver " + driver);

      java.sql.Driver driver2 = DriverManager.getDriver("jdbc:oracle:thin://");
      System.out.println("oracleDriver " +driver2);

      java.sql.Driver driver3 = DriverManager.getDriver("jdbc:sqlserver://");
      System.out.println("sqlDriver " +driver3);

      java.sql.Driver driver4 = DriverManager.getDriver("jdbc:mysql://");
      System.out.println("mysqlDriver " +driver4);
