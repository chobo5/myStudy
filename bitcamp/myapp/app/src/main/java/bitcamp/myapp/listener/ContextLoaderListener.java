...
public class ContextLoaderListener implements ServletContextListener {
    // 웹 어플리케이션이 사용할 자원을 준비하고 해제시키는 역할
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        ServletContext 웹어플리케이션저장소 = sce.getServletContext();
        웹어플리케이션저장소.setAttribute("assignmentDao", assignmentDao);
        웹어플리케이션저장소.setAttribute("memberDao", memberDao);
        웹어플리케이션저장소.setAttribute("boardDao", boardDao);
        웹어플리케이션저장소.setAttribute("attachedFileDao", attachedFileDao);
        웹어플리케이션저장소.setAttribute("txManager", txManager);
