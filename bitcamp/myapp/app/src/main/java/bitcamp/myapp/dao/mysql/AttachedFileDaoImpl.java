...
public class AttachedFileDaoImpl implements AttachedFileDao {
    ...
    public void add(AttachedFile file) {
        try (Connection con = connectionPool.getConnection();
             PreparedStatement pstmt = con.prepareStatement("insert into board_files(file_no,file_path,board_no) values(?, ?, ?)")) {
    ...
    public List<AttachedFile> findAllByBoardNo(int boardNo) {
        try (Connection con = connectionPool.getConnection();
             PreparedStatement pstmt = con.prepareStatement("select file_no, file_path, board_no from board_files where board_no=? order by file_no asc")) {
