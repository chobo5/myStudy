...
public class MemberMenu {
    private static final String[] MEMBER_MENU = {"회원 관리", "1.등록", "2.조회", "3.변경", "4.삭제","5.목록", "0.이전"};
    ...
    private static void find() {
        ...
        String strIndex = Prompt.getUserInput("메인/회원관리", "조회할 회원의 번호를 입력하세요.");
    ...
    private static void modify() {
        ...
        String strIndex = Prompt.getUserInput("메인/회원관리", "변경할 회원 번호를 입력하세요.");
        int index = Integer.parseInt((strIndex));
    ...
    private static void delete() {
        ...
        String strIndex = Prompt.getUserInput("메인/회원관리", "삭제할 회원의 번호를 입력하세요.");
        int index = Integer.parseInt(strIndex);
        if (index >= 0 && index < currentIndex) {
